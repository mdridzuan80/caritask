    				...
    				<div class="card">
    							...
    							<tbody>
    								<?php foreach ($tasks as $task) { ?>
    									<tr>
    										...
    										<?php if (hasRole('worker')) { ?>
    											<td><a type="button" class="btn btn-block btn-primary btn-accept" data-taskid="<?= $task->id ?>" href="<?= site_url('tasks/accept') ?>"><i class="fas fa-plus"></i> Accept</a></td>
    										<?php } ?>
    									</tr>
    								<?php } ?>
    							</tbody>
    					...
    					<div class="card-body">
    						<table class="table table-bordered">
    							...
    							<tbody>
    								<?php foreach ($accepted_tasks as $task) { ?>
    									<tr>
    										<td></td>
    										<td><?= $task->sname ?></td>
    										<td><?= $task->ssname ?></td>
